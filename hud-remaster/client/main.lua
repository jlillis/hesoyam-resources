...
-- Replaces all textures on resource start
local function replaceTextures()
	for _, textureName in ipairs(textureNames) do
		...
		local texture = dxCreateTexture("client/textures/"..textureName..".png")
